...
func _draw():
	...
	draw_string(font, x_label_position, "Popped at x Pumps", HORIZONTAL_ALIGNMENT_CENTER, -1, 16, chart_color)
	# Draw y-axis label
	...
	draw_string(font, title_loc, "Histogram: Number of Pumps until Pop", HORIZONTAL_ALIGNMENT_CENTER, -1, 18, chart_color)
